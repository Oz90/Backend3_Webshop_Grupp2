...
export const RegisterForm = () => {
  ...
  const handleOnSubmit = (e) => {
    e.preventDefault()
    url.post("users/register", registerValue)
  }
  ...
  return (
    <StyledDiv>
      <StyledForm onSubmit={handleOnSubmit} onChange={handleOnChange}>
        ...
        <StyledInput name="displayName" type="text" placeholder="Display Name" />
        <StyledInput name="phoneNumber" type="number" placeholder="Phone Number" />
